...
class PhoneNumberSubmittedListener extends StatelessWidget {
  const PhoneNumberSubmittedListener({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocListener<PhoneAuthCubit, PhoneAuthState>(
      listenWhen: (previous, current) {
        if (current is PhoneAuthSubmittedState ||
      ...
      listener: (context, state) {
        if (state is PhoneAuthSubmittedState) {
